...
/**
 *  Creates the oauth headers to be included to the request to Twitter API.
 *  @see com.twitter.hbc.httpclient.auth.OAuth1
 */
@Component
public class OAuthSignatureUtils {
    ...
    public OAuthSignatureUtils(OAuthCredentials credentials) {
